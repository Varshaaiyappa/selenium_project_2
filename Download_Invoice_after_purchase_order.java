	...
	if (p.checkout_button.isDisplayed()==true) {
		   

		 JavascriptExecutor jse = (JavascriptExecutor)driver;

		 jse.executeScript("arguments[0].scrollIntoView()", p.checkout_button);
	...
	Thread.sleep(2500);
	p.signup_name.sendKeys("user2560721");
	Thread.sleep(2500);
	p.signup_email.sendKeys("user2560721@gmail.com");
	Thread.sleep(2500);
